...
class DenseNet():
  ...
  Attributes:
        size : size of the network choose from (28, 37 ,45)
  ...
  def build_qkeras_densenet_e37(self):
    ...
    :return: qkeras model of the densenet_e37
    """
    input_layer = tf.keras.Input(shape=(224, 224, 3))
    qkeras_densenet = tf.keras.layers.Conv2D(64, kernel_size=7, strides=2,
                                             padding="same",
  ...
  def build_larq_densenet_e37(self):
    """
    Build the larq version of the densenet_e37
    :return: larq model of the densenet_e37
    """
    input_layer = tf.keras.Input(shape=(224, 224, 3))
    larq_densenet = tf.keras.layers.Conv2D(64, kernel_size=7, strides=2,
                                           padding="same",
  ...
  def build_qkeras_densenet_e45(self):
    ...
    :return: qkeras model of the densenet_e45
    """
    input_layer = tf.keras.Input(shape=(224, 224, 3))
    qkeras_densenet = tf.keras.layers.Conv2D(64, kernel_size=7, strides=2,
                                             padding="same",
  ...
  def build_larq_densenet_e45(self):
    ...
    :return: larq model of the densenet_e45
    """
    input_layer = tf.keras.Input(shape=(224, 224, 3))
    larq_densenet = tf.keras.layers.Conv2D(64, kernel_size=7, strides=2,
                                           padding="same",
