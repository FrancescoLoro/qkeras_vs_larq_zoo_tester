...
DENSENET_E37_DILATED_NAME = "binary_densenet_e28_dilated"
...
class DenseNetE37Dilated:
  ...
  @staticmethod
  def add_connection_block(model, filters_num, max_pool=0):
    """
  ...
  def build_qkeras_densenet_e37_dilated(self):
    ...
    :return: qkeras model of the densenet_e37_dilated
    """
  ...
  def build_larq_densenet_e37_dilated(self):
    ...
    :return: larq model of the densenet_e37_dilated
    """
    input_layer = tf.keras.Input(shape=(224, 224, 3))
